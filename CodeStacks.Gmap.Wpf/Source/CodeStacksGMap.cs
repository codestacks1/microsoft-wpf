...
{
    public class CodeStacksGMap : GMapControl
    {
...
//            FormattedText text = new FormattedText(string.Format("Xiaowen.CodeStacks.Wpf.Gmap.gmap"), CultureInfo.InvariantCulture, fd, tf, 12, Brushes.Gray);
