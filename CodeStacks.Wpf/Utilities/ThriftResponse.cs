...
namespace Xiaowen.CodeStacks.Wpf.Utilities
{
    ...
    public partial class ThriftResponse
    {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public static TResult GetResult<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(TTransport transport, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> thriftOpt, params object[] param)
          where TResult : new()
        {
            TResult t = new TResult();
        ...
        public static TResult GetResult<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(TTransport transport, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult> thriftOpt, params object[] param)
          where TResult : new()
        {
            TResult t = new TResult();
